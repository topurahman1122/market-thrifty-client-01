...
const Stats = () => {
    return (
        <div>
            <section className="p-6 my-6 bg-base-100 text-gray-900">
                <div className="container grid grid-cols-1 gap-6 mx-auto sm:grid-cols-2 xl:grid-cols-4">
                    <div className="flex p-4 space-x-4 rounded-lg md:space-x-6 bg-gray-300 text-gray-900">
                        <div className="flex justify-center p-2 align-middle rounded-lg sm:p-4 bg-base-300">
